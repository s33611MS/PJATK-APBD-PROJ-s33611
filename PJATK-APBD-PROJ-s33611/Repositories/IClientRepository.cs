...
public interface IClientRepository
{
    ...
    Task<IndividualClient?> GetIndividualByIdAsync(int id, CancellationToken cancellationToken);
    Task<CompanyClient?> GetCompanyByIdAsync(int id, CancellationToken cancellationToken);
